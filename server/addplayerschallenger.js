...
var region = process.argv.slice(2)[1];
	...
	var getJSON = require('get-json')
 	var url = "https://" + region + ".api.riotgames.com/lol/league/v3/challengerleagues/by-queue/RANKED_SOLO_5x5?api_key=" + apikey;
			    ...
			    for (var i in res.rows) {
					...
					for (var i = 0; i < playerNames.length; i++) {
						...
						if (playerNamesInTable.indexOf(playerNames[i]) != -1) {
						    ...
						    client.query("INSERT INTO players" + region + "(playerName,rank,playerId) values($1, 'challenger', $2)", values, (err, res) => {
								console.log(err);
								console.log(res);
							});
						}
